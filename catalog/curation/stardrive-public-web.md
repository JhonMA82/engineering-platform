# Curation evidence — stardrive-public-web

- Upstream: <https://github.com/JhonMA82/stardrive-public-web>
...
- Gaps (explicit): license unverified; pin unreachable; no setup/checks;
  no pilot; Astro-specific build/adapter behavior unverified.
